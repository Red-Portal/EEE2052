...
<drawing version="7">
    ...
    <netlist>
        ...
        <block symbolname="ram16x1d" name="XLXI_19">
            ...
            <blockpin signalname="DPRA(0)" name="DPRA0" />
            <blockpin signalname="DPRA(1)" name="DPRA1" />
            <blockpin signalname="DPRA(2)" name="DPRA2" />
            <blockpin signalname="XLXN_67" name="DPRA3" />
            <blockpin signalname="WCLK" name="WCLK" />
            <blockpin signalname="WE" name="WE" />
            <blockpin signalname="DPO(0)" name="DPO" />
            <blockpin signalname="SPO(0)" name="SPO" />
        </block>
        ...
        <block symbolname="ram16x1d" name="XLXI_22">
            ...
            <blockpin signalname="WCLK" name="WCLK" />
            <blockpin signalname="WE" name="WE" />
            <blockpin signalname="DPO(1)" name="DPO" />
            <blockpin signalname="SPO(1)" name="SPO" />
        </block>
        ...
        <block symbolname="ram16x1d" name="XLXI_25">
            ...
            <blockpin signalname="WCLK" name="WCLK" />
            <blockpin signalname="WE" name="WE" />
            <blockpin signalname="DPO(2)" name="DPO" />
            <blockpin signalname="SPO(2)" name="SPO" />
        </block>
        ...
        <block symbolname="ram16x1d" name="XLXI_28">
            ...
            <blockpin signalname="WCLK" name="WCLK" />
            <blockpin signalname="WE" name="WE" />
            <blockpin signalname="DPO(3)" name="DPO" />
            <blockpin signalname="SPO(3)" name="SPO" />
        </block>
        ...
        <block symbolname="ram16x1d" name="XLXI_31">
            ...
            <blockpin signalname="WCLK" name="WCLK" />
            <blockpin signalname="WE" name="WE" />
            <blockpin signalname="DPO(4)" name="DPO" />
            <blockpin signalname="SPO(4)" name="SPO" />
        </block>
        ...
        <block symbolname="ram16x1d" name="XLXI_37">
            ...
            <blockpin signalname="WCLK" name="WCLK" />
            <blockpin signalname="WE" name="WE" />
            <blockpin signalname="DPO(5)" name="DPO" />
            <blockpin signalname="SPO(5)" name="SPO" />
        </block>
        ...
        <block symbolname="ram16x1d" name="XLXI_40">
            ...
            <blockpin signalname="WCLK" name="WCLK" />
            <blockpin signalname="WE" name="WE" />
            <blockpin signalname="DPO(6)" name="DPO" />
            <blockpin signalname="SPO(6)" name="SPO" />
        </block>
        ...
        <block symbolname="ram16x1d" name="XLXI_43">
            ...
            <blockpin signalname="WCLK" name="WCLK" />
            <blockpin signalname="WE" name="WE" />
            <blockpin signalname="DPO(7)" name="DPO" />
            <blockpin signalname="SPO(7)" name="SPO" />
        </block>
    ...
    <sheet sheetnum="1" width="3520" height="2720">
        ...
        <iomarker fontsize="28" x="288" y="224" name="D(7:0)" orien="R180" />
